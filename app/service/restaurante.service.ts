    ...
    export class RestauranteService{
        ...
        getRestaurante(id: string, random = null){
       	...
       	addRestaurante(restaurante: Restaurante) {
            ...
            console.log(params);
            return this._http.post("http://localhost/restaurante/restaurantes-api.php/restaurantes", 
        ...
        editRestaurante(id:string, restaurante: Restaurante) {
            ...
            let headers = new Headers({'Content-Type':'application/x-www-form-urlencoded'});
            console.log(params);
            return this._http.post("http://localhost/restaurante/restaurantes-api.php/update-restaurante/"+id, 
                    params, {headers: headers}).map(res => res.json());
	    }
